...
Using web search, collect current data for the following 10 AFC and OFC teams:
Australia, Iraq, IR Iran, Japan, Jordan, Korea Republic, New Zealand, Qatar, Saudi Arabia, Uzbekistan
...
- last_tournament_stage: most recent major tournament result, e.g. "SF Asian Cup 2023", "QF WC 2022", "Group Stage WC 2022". Use "Did not qualify" if they missed the last tournament
...
- confederation_form: MUST be one of → "dominant" | "strong" | "average" | "weak" — based on how AFC/OFC teams performed in the last 18 months of international football. Use the same value for all AFC teams; use "weak" for New Zealand (OFC) unless evidence suggests otherwise.
- host_boost: false for all AFC/OFC teams (none are co-hosts)
...
Output ONLY a valid JSON array of all 10 objects.
