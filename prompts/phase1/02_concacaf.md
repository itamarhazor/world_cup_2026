...
Using web search, collect current data for the following 6 CONCACAF teams:
...
- confederation_form: MUST be one of → "dominant" | "strong" | "average" | "weak" — based on how CONCACAF teams performed in the last 18 months of international football
- host_boost: true for Canada, Mexico, USA (co-hosts); false for Curaçao, Haiti, Panama
- altitude_games: true if this team is scheduled to play at Estadio Azteca (Mexico City, 2,240m altitude) AND they do not regularly train or compete at altitude. Set false for Mexico.
