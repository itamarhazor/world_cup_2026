...
Using web search, collect current data for the following 10 CAF teams:
...
- last_tournament_stage: most recent major tournament result, e.g. "SF Copa America 2024", "QF AFCON 2023", "Group Stage WC 2022". Use "Did not qualify" if they missed the last tournament
...
- confederation_form: MUST be one of → "dominant" | "strong" | "average" | "weak" — based on how CAF teams performed in the last 18 months of international football
- host_boost: false for all CAF teams (none are co-hosts)
